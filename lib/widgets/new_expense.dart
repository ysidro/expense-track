...
class _NewExpensesState extends State<NewExpense>{
    ...
    _selectedDate == null){
      // show error message
        showDialog(context: context, builder: (ctx) => AlertDialog(
          ...
          content: const Text('Pease make sure a valid title, amount, date an category was entered'),
          actions: [
  ...
  Widget build(BuildContext context) {
    return Padding(
    padding: EdgeInsets.fromLTRB(16, 60, 16, 16), //EdgeInsets.all(25),
    child: Column(
      children: [
        TextField(
        ...
        Expanded(child: 
          ...
          Expanded(child: 
            Row(
              ...
              children:[
                Text(_selectedDate == null ? 'Selected Date' : formatter.format(_selectedDate!).toString()),
